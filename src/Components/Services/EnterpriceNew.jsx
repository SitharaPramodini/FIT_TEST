...
<p className="description">
  {expandedIndex === 0 ? "The first Wi-Fi standard (IEEE 802.11) was released in 1997, offering speeds of up to 2 Mbps. Today's Wi-Fi 6 standard can reach speeds of up to 9.6 Gbps":"The first Wi-Fi standard (IEEE 802.11) was released in 1997, offering speeds of up to 2 Mbps. Today's Wi-Fi 6 standard can reach speeds of up to 9.6 Gbps".split(".")[0] + "."}
</p>
<button
...
<p className="description">
  {expandedIndex === 1 ? "Apple introduced the first commercial Wi-Fi product in 1999 with the iBook, which included an internal wireless card and the AirPort base station. ":"Apple introduced the first commercial Wi-Fi product in 1999 with the iBook, which included an internal wireless card and the AirPort base station. ".split(".")[0] + "."}
</p>
<button
  className="readmore-btn"
