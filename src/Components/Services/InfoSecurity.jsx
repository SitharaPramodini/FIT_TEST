    ...
    <div>
      ...
      <div className="home flex flex-row flex-wrap justify-around bg-[#161616] md:px-24 px-4  py-16">
        <div className="flex flex-col">
          {/* <h4 className=" text-title text-xl font-semibold leading-none text-[#ff6000] md:text-2xl text-center">Dependable Tech - Comprehensive Solutions</h4> */}
          <h2 className=" text-title mt-4 text-3xl font-bold text-white md:text-5xl md:leading-[1.2] text-center px-12">Services Offered by Fentons Information Technology (FIT)</h2>
